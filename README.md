...
<p align="center">
  <a href="https://github.com/BlommeJan/penfold"><img src="https://img.shields.io/static/v1?label=version&message=0.2.69&color=blue" alt="Version 0.2.69" /></a>
...
|----------|-------------|
| [CHANGELOG.md](CHANGELOG.md) | Version history (v0.1.0 – v0.2.69) |
...
<p align="center">
  <strong>Penfold v0.2.69</strong> — write freely, keep it local.
</p>
