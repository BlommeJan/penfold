...
**Pages** — Vertical scroll through multi-page notebooks, page overview grid with drag-reorder and multi-select batch delete, blank/lined/grid/dotted/college-ruled templates, A4/A5/Letter sizes, image insert, PDF import (rendered once to local PNG), and export current page or full notebook as PNG or vector PDF (ink strokes stay crisp at any zoom).
...
|----------|-------------|
| [CHANGELOG.md](CHANGELOG.md) | Version history (v0.1.0 – v0.2.31) |
...
<p align="center">
  <strong>Penfold v0.2.31</strong> — write freely, keep it local.
</p>
