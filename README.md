...
<p align="center">
  <a href="https://github.com/BlommeJan/penfold"><img src="https://img.shields.io/static/v1?label=version&message=0.2.32&color=blue" alt="Version 0.2.32" /></a>
...
**Pages** — Vertical scroll through multi-page notebooks, page overview grid with drag-reorder and multi-select batch delete, blank/lined/grid/dotted/college-ruled templates, A4/A5/Letter sizes, image insert, PDF import (lazy render with read-only hyperlinks), and export current page or full notebook as PNG or vector PDF (ink strokes stay crisp at any zoom).
...
|----------|-------------|
| [CHANGELOG.md](CHANGELOG.md) | Version history (v0.1.0 – v0.2.32) |
...
<p align="center">
  <strong>Penfold v0.2.32</strong> — write freely, keep it local.
</p>
