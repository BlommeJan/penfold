...
Install the release APK from `APKs/` (for example `Penfold-v0.2.73.apk`) on your Android tablet or phone, then work through the sections below. Check each box when the feature works as expected.
...
*Last updated for Penfold v0.2.73*
