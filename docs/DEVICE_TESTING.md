...
Install the release APK from `APKs/` (for example `Penfold-v0.2.68.apk`) on your Android tablet or phone, then work through the sections below. Check each box when the feature works as expected.
...
> Document-level zoom UX improvements in **v0.2.68** (content stays visible during pinch zoom in/out).
...
*Last updated for Penfold v0.2.68*
